<div class="row">
				...
				<table id="Categories" class="table table-bordered table-striped table-responsive">
					<thead>
						<tr>
													...
													<th class="text-left"><?php echo __("description"); ?></th>
	...
	<tr>
		...
		<td class="text-left"><?php echo h($category['Category']['description']); ?>&nbsp;</td>
		<td class="text-left"><?php echo h($category['Category']['created']); ?>&nbsp;</td>
		<td class="text-left"><?php echo h($category['Category']['modified']); ?>&nbsp;</td>
		<td class="text-left">

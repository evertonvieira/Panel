<div class="row">
				...
				<table id="News" class="table table-bordered table-striped table-responsive">
					<thead>
						<tr>
													...
													<th class="text-left"><?php echo __("summary"); ?></th>
													...
													<th class="text-left"><?php echo __("thumb"); ?></th>
	...
	<tr>
		...
		<td class="text-left"><?php echo h($news['News']['summary']); ?>&nbsp;</td>
		<td class="text-left"><?php echo h($news['News']['body']); ?>&nbsp;</td>
		<td class="text-left"><?php echo h($news['News']['ext']); ?>&nbsp;</td>
		<td class="text-left"><?php echo h($news['News']['data']); ?>&nbsp;</td>
		<td class="text-left"><?php echo h($news['News']['status']); ?>&nbsp;</td>
		<td class="text-left"><?php echo h($news['News']['created']); ?>&nbsp;</td>
		<td class="text-left"><?php echo h($news['News']['modified']); ?>&nbsp;</td>
		<td class="text-left"><?php echo h($news['News']['featured']); ?>&nbsp;</td>
		<td class="text-left"><?php echo h($news['News']['thumb']); ?>&nbsp;</td>
		<td class="text-left">

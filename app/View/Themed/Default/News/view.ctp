...
<div class="row">
	<div class="col-xs-12">
...
</tr><tr>		<td><strong><?php echo __('Featured'); ?></strong></td>
		<td>
			<?php echo h($news['News']['featured']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Thumb'); ?></strong></td>
		<td>
			<?php echo h($news['News']['thumb']); ?>
			&nbsp;
		</td>
</tr>					</tbody>
				</table>
		...
		<tr>
			...
			<td class="text-center"><?php echo $category['description']; ?></td>
			<td class="text-center"><?php echo $category['created']; ?></td>
			<td class="text-center"><?php echo $category['modified']; ?></td>

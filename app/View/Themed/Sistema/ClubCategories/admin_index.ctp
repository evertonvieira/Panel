					...
					<tbody>
						<?php foreach ($clubCategories as $clubCategory): ?>
							<tr>
								...
								<td class="text-left"><?php echo $this->Formatacao->dataHora($clubCategory['ClubCategory']['created']); ?>&nbsp;</td>
								<td class="text-left"><?php echo $this->Formatacao->dataHora($clubCategory['ClubCategory']['updated']); ?>&nbsp;</td>
								<td class="text-left">

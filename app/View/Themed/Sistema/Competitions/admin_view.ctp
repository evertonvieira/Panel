		...
		<div class="box box-primary">
			...
			<div class="box-body table-responsive">
				<table id="Competitions" class="table table-bordered table-striped">
					<tbody>
						<tr>
							<td><strong><?php echo __('Id'); ?></strong></td>		<td>
						...
						<tr>
							...
							<td>
								<?php echo $this->Formatacao->dataHora($competition['Competition']['data']); ?>
								&nbsp;
							</td>
						</tr>
						<tr>
							<td><strong><?php echo __('Estadio'); ?></strong></td>
							<td>
						...
						<tr>
							<td><strong><?php echo __('Score First'); ?></strong></td>
							<td>
						...
						<tr>
							<td><strong><?php echo __('Score Second'); ?></strong></td>
							<td>
						...
						<tr>
							<td><strong><?php echo __('Championship'); ?></strong></td>
							<td>
						...
						<tr>
							...
							<td>
								<?php echo $this->Formatacao->dataHora($competition['Competition']['created']); ?>
								&nbsp;
							</td>
						</tr>
						<tr>
							...
							<td>
								<?php echo $this->Formatacao->dataHora($competition['Competition']['updated']); ?>
								&nbsp;
							</td>
						</tr>
					</tbody>

		...
		<div class="box box-primary">
			...
			<div class="box-body table-responsive">
				<table id="Players" class="table table-bordered table-striped">
					...
					<tr>
						<td><strong><?php echo __('Data Nascimento'); ?></strong></td>
						<td>
					...
					<tr>
						<td><strong><?php echo __('N Contrato'); ?></strong></td>
						<td>
					...
					<tr>
						<td><strong><?php echo __('Sexo'); ?></strong></td>
							<td>
								<?php echo $this->Formatacao->sexo($player['Player']['sexo']); ?>
								&nbsp;
							</td>
					</tr>
					<tr>
						<td><strong><?php echo __('Nacionalidade'); ?></strong></td>
						<td>
					...
					<tr>
						<td><strong><?php echo __('Filiacao Pai'); ?></strong></td>
						<td>
					...
					<tr>
						<td><strong><?php echo __('Filiacao Mae'); ?></strong></td>
						<td>
					...
					<tr>
						<td><strong><?php echo __('Escolaridade'); ?></strong></td>
						<td>
							<?php echo $this->Formatacao->escolaridade($player['Player']['escolaridade']); ?>
							&nbsp;
						</td>
					</tr>
					<tr>
						<td><strong><?php echo __('Identidade'); ?></strong></td>
						<td>
					...
					<tr>
						<td>
							<strong><?php echo __('Orgao Identidade'); ?></strong></td>
						<td>
					...
					<tr>
						<td><strong><?php echo __('N Carteira'); ?></strong></td>
						<td>
					...
					<tr>
						<td><strong><?php echo __('Carteira Serie'); ?></strong></td>
						<td>
					...
					<tr>
						<td><strong><?php echo __('N Certidao Nascimento'); ?></strong></td>
						<td>
					...
					<tr>
						<td><strong><?php echo __('Nascimento Cartorio'); ?></strong></td>
						<td>
					...
					<tr>
						<td><strong><?php echo __('Nascimento Livro'); ?></strong></td>
						<td>
					...
					<tr>
					<td><strong><?php echo __('Nascimento Folha'); ?></strong></td>
						<td>
					...
					<tr>
						<td><strong><?php echo __('Militar N'); ?></strong></td>
						<td>
					...
					<tr>
						<td><strong><?php echo __('Militar Ministerio'); ?></strong></td>
						<td>
					...
					<tr>
						<td><strong><?php echo __('N Casa'); ?></strong></td>
						<td>
					...
					<tr>
						<td><strong><?php echo __('Data Pagamento'); ?></strong></td>
						<td>
					...
					<tr>
						...
						<td>
							<?php echo $this->Formatacao->dataHora($player['Player']['created']); ?>
							&nbsp;
						</td>
					</tr>
					<tr>
						...
						<td>
							<?php echo $this->Formatacao->dataHora($player['Player']['updated']); ?>
							&nbsp;
						</td>
					</tr>
					</tbody>

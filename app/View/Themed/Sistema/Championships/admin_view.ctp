	...
	<div class="col-xs-12">
		...
		<div class="box box-primary">
			<div class="box-header">
				...
				<div class="box-tools pull-right">
					<?php echo $this->Html->link('<i class="glyphicon glyphicon-plus"></i> '.__('New Competition'), array('controller' => 'competitions', 'action' => 'add'), array('class' => 'btn btn-primary', 'escape' => false)); ?>
				</div><!-- /.actions -->
			</div>
						...
						<tbody>
							...
							foreach ($championship['Competition'] as $competition): ?>
								<tr>
									...
									<td class="text-center"><?php echo $this->Formatacao->dataHora($competition['created']); ?></td>
									<td class="text-center"><?php echo $this->Formatacao->dataHora($competition['updated']); ?></td>
									<td class="text-center">

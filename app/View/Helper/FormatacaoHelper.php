...
/**
 * Mostrar a data dia mes abreviado DEZ e ano
 *
 * @param integer $dataHora Data e hora em timestamp ou null para atual
 * @param string $mes n para retornar o mês em números ou s padrão para para string
 * @return array <strong>26</strong><small><p class="size_14">dez</p> 2013</small>"
 * @access public
 */
	function data_completa_abreviada($data = null, $mes = 's') {
  	$_meses = array(
    __('Jan'),
    __('Feb'),
    __('Mar'),
    ...
    $data = Functions::formata_data( $data, '/', '-' );
		$dataHora = $this->_ajustaDataHora($data);
		$n = date('n', $dataHora) - 1;
    $return = array(
      'dia'=> date('d', $dataHora),
      'mes'=> $_meses[$n],
    ...
    if ($mes == 'n') $return['mes'] = date('m', $dataHora);
		return $return;
	}
...
/**
 * Converte status em numérico ou em string
 *
 * @param string status
 * @return string Status
 * @access public
 */
	function visivel($status) {
